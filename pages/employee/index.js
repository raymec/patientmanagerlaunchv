...
export default function Home() {
  ...
  //   router.push(
  //     {
  //       pathname: `/results/NurseResults/${searchPatient}`,
  //     },
  //     undefined,
  //     { shallow: true }
  //   );
            ...
            <div className="text-center">
              ...
              <div>
                <button
                  ...
                  type="button"
                  className="inline-flex items-center rounded-md border border-transparent px-6 py-3 text-base font-medium shadow-sm  focus:outline-none focus:ring-2 focus:ring-offset-2"
                >
                  Create Orders
                </button>
                <button
